...
I have learned about relative paths: `relative="route"` vs `relative="path"`.
Sometimes we need to go up one level in the current contextual route path,
instead of one level in the Route hierarchy. Here is an example:
